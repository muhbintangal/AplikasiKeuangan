...
public class pengeluaran extends JPanel {
    ...
    private void initUI() {
        ...
        JLabel titleLabel = new JLabel("Add Expenses");
        ...
        // Value tombol ini akan masuk ke 'titleField'
        JPanel chipPanel1 = createChipPanel(
            new String[]{"Makanan", "Listrik", "Belanja", "Jajan"},
            titleField 
        );
        ...
        // Value tombol ini akan masuk ke 'newCatField'
        JPanel chipPanel2 = createChipPanel(
            new String[]{"Makan & Minum", "Jajan", "Transportasi"},
            newCatField
        );
    ...
    // UPDATE: Menambahkan parameter JTextField targetField
    private JPanel createChipPanel(String[] labels, JTextField targetField) {
        ...
        for (String label : labels) {
            // Gunakan Class RoundedButton (Custom)
            RoundedButton btn = new RoundedButton(label);
            
            // LOGIKA KLIK: Masukkan teks tombol ke kolom input
    ...
    class RoundedButton extends JButton {
        ...
        protected void paintBorder(Graphics g) {
            ...
            // Arc Width & Height disamakan dengan Height tombol agar bulat sempurna
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            frame.add(new pengeluaran(), BorderLayout.CENTER);
